      ...
      <table border=1 cellpadding=2 cellspacing=0 bordercolordark=#FFFFFF bordercolorlight=#666666 width=100%>
        ...
        <tr>
          ...
          <td> 
            ...
            <div align="center"><b><font face="Tahoma">Titre</font></b></div>

          </td>

          <td>

            <div align="center"><b><font size="2" face="Tahoma">Support</font></b></div>

          </td>

          <td>

            <div align="center"><b><font face="Tahoma" size="2">Langue</font></b></div>

          </td>

          <td>

            <div align="center"><b><font face="Tahoma" size="2">Description</font></b></div>

          </td>

          <td>

            <div align="center"><b><font face="Tahoma" size="2">Image</font></b></div>
...
$sql = 'SELECT nom,support,langue,description,images FROM liste ORDER BY nom'; 
...
while($data = mysql_fetch_array($req)) 
  ...
  { 
    ...
    echo $data["<a href='images.html'>'nom'<a>"].'<br>'; 
...
<center><br><font class='text0'> | http://PhpMyDivX.free.fr | Copyright PhpMyDivX® 2001 | By InKLy et Choizo | </font></center>